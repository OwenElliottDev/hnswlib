...
|Geographic distance|'geodegrees'    | great-circle (haversine) distance in kilometers between (latitude, longitude) points given in degrees; requires dim=2 and float32 |
